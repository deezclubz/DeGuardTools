...
#
#
# def get_transactions_data(address, end_block, start_block=START_BLOCK, page=1, offset=1000):
#     params = {
#         'module': 'account',
#         'action': 'txlist',
#         'address': address,
...
#                 "from": data[i]['from'],
#                 "to": data[i]['to'],
#                 "transaction_date": datetime.utcfromtimestamp(int(data[i]['timeStamp'])).strftime(
#                     '%Y-%m-%d %H:%M:%S'),
#                 "value_in_bnb": int(data[i]['value']) / 10 ** 18
#             })
#
#         return result
#
#
# def fetch_all_transactions(address, start_block):
#     result_transaction = []
...
#         print(current_block)
#         next_block = min(current_block + 10000, end_block)
#         tpm_transaction = [get_transactions_data(address, current_block, next_block)]
#         result_transaction.append(tpm_transaction)
#         current_block += 1
#
#     return result_transaction
#
#
# print(fetch_all_transactions(ADDRESS, start_block=START_BLOCK))
